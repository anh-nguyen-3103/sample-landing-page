export const Images = {
  bobidi: '/assets/images/bobidi-logo.png',
  joongang: '/assets/images/joongang-logo.png',
...
export const Backgrounds = {
  footer: '/assets/images/backgrounds/footer.png',
  statistic: '/assets/images/backgrounds/statistic.png',
}
